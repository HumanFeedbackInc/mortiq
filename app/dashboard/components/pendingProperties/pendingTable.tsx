...
// import PendingListingTable from "../";
// import { getPendingProperties } from "@/app/actions";
...
export default function PendingPropertiesTable({
  ...
  listingsWithImages: ListingWithImages[];
}) {
  ...
  //     redirect("/sign-in");
  //   }
  //   const listings = (await getPendingProperties()) as Listing[];
