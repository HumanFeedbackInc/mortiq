...
export type accountType = Database['public']['Tables']['account']['Row'];
// export type userType = Database['public']['Tables']['auth_users']['Row'];
export type pendingAccountType = Database['public']['Tables']['pending_user']['Row'];
