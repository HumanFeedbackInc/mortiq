...
// import CompanyInformationForm from "./property-image-upload-form";
import PropertyDocumentUploadForm from "./property-document-upload-form";
  ...
  const content = React.useMemo(() => {
    ...
    switch (page) {
      case 1:
        ...
        break;
      case 2:
        component = <PropertyDocumentUploadForm />;
        break;
      case 3:
